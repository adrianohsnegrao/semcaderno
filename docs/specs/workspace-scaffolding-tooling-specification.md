...
| Argon2 | `argon2 0.45.1` | Maintained direct Node binding with Argon2id/PHC verification, bundled TypeScript declarations, Node-API prebuilds, and Node 24 compatibility; native install script is explicitly reviewed and allowlisted. | Persistence-owned exact pin; update with supply-chain review and real credential/PostgreSQL gates. |
...
Primary evidence: [Node releases](https://nodejs.org/en/about/previous-releases), [pnpm installation](https://pnpm.io/installation), [pnpm CI](https://pnpm.io/continuous-integration), [TypeScript 6.0](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-6-0.html), [Next.js support policy](https://nextjs.org/support-policy), [Fastify LTS](https://fastify.dev/docs/latest/Reference/LTS/), [OpenAPI 3.2.0](https://spec.openapis.org/oas/v3.2.0.html), [PostgreSQL 18.4](https://www.postgresql.org/docs/release/18.4/), [Testcontainers PostgreSQL](https://node.testcontainers.org/modules/postgresql/), [node-pg-migrate](https://salsita.github.io/node-pg-migrate/), and [`argon2` 0.45.1](https://github.com/ranisalt/node-argon2/tree/v0.45.1).
